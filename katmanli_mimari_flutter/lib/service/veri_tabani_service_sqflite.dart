...
class SqfliteVeriTabaniService implements VeriTabaniService {
  ...
  Future<void> _tabloOlustur(Database db, int versiyon) async {
    ...
    FOREING KEY ("$_kitapIdBolumler") REFERENCES 
    "$_kitaplarTabloAdi"("$_idKitaplar") ON DELETE CASCADE ON UPDATE CASCADE);
    ''');
  }
  ...
  epostaVeSifreIleKayit(String adSoyad, String eposta, String sifre) {}

  appleIleGiris() {}

  epostaVeSifreIleGiris(String eposta, String sifre) {}

  googleIleGiris() {}

  kullaniciIdsiniGetir() {}

  sifreSifirla(String eposta) {}

  telefonDogrulamaKodunuOnayla(String dogrulamaIdsi, String dogrulamaKodu) {}

  telefonDogrulamaKoduGonder(String telefonNumarasi,
